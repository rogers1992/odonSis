...
@section('content')
      ...
      <div class="row">
        <div class="col-m-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Llene los datos del nuevo doctor <small>(*) dato requerido</small></h2>
            ...
            <div class="x_content">
              {{ Form::open(['route' => 'doctores.store', 'method'=>'POST', 'files' => 'true', 'class'=>'form-horizontal form-label-left']) }}
              {!! csrf_field() !!}
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="name" name="name" placeholder="" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
              </div><br>
                <div class="item form-group">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="password" id="password" name="password" required="required" class="form-control col-md-7 col-xs-12" data-validate-length="6,8">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">Repetir Contraseña <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="password" id="password_confirm" name="password_confirm" required="required" class="form-control col-md-7 col-xs-12" data-validate-linked="password">
                  </div>
                </div>
